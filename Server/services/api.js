...
const bmrAndDiet = async (req, res) => {
    try {
        ...
        if (userInputs.success) {
            ...
            const gender = userInputs.data.gender

            const prompt = `${BMR_PROMPT} AGE:${age}, HEIGHT:${height}, GENDER:${gender}, WEIGHT:${weight} ,ACTIVITY LEVEL:${activity}; ${DIET_PROMPT} ${type}, MEALS ${meals}, DON'T INCLUDE THESE FOOD ITEMS IN THE DIET PLAN ${exception}, FOR ${forwhat}; ONLY PRINT BMR WHICH YOU CALCULATED AND ALL THE MEALS, THATS IT!`
