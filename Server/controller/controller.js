...
const { additem, finditem, viewitems } = require("../services/service")
...
module.exports = { signupHandler, loginHandler, additemHandler, finditemHandler, allitemsHandler, bmrAndDietHandler}