                        ...
                        if (type) {
                            if (meals) {
                                if (forwhat) {
                                    if (gender) {
                                        try {
                                            const response = await axios.post(`${LINK}/api/bmranddiet?token=${token}`, data)
    ...
    return <div style={{
        ...
        <div className="apipage" >
            ...
            <div className="apibox"><div>
                ...
                <input className="inputboxapi" placeholder="Gender" type="text" value={gender} onChange={genderHandler}></input>
